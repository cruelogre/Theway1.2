...
local Sprite_1 = cc.Sprite:createWithSpriteFrameName("guandan_label_pair.png")
Sprite_1:setName("Sprite_1")
Sprite_1:setTag(10)
Sprite_1:setCascadeColorEnabled(true)
Sprite_1:setCascadeOpacityEnabled(true)
Sprite_1:setPosition(0.3724, 14.5187)
layout = ccui.LayoutComponent:bindLayoutComponent(Sprite_1)
layout:setSize({width = 281.0000, height = 173.0000})
layout:setLeftMargin(-140.1276)
layout:setRightMargin(-140.8724)
layout:setTopMargin(-101.0187)
layout:setBottomMargin(-71.9813)
...
localFrame:setX(0.3717)
localFrame:setY(14.5187)
...
localFrame:setTween(true)
localFrame:setTweenType(0)
localFrame:setScaleX(2.5581)
localFrame:setScaleY(2.5581)
