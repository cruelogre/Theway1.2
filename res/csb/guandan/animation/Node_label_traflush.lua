...
local Sprite_1 = cc.Sprite:createWithSpriteFrameName("guandan_label_straflush.png")
Sprite_1:setName("Sprite_1")
Sprite_1:setTag(12)
Sprite_1:setCascadeColorEnabled(true)
Sprite_1:setCascadeOpacityEnabled(true)
Sprite_1:setPosition(1.3416, 9.4019)
layout = ccui.LayoutComponent:bindLayoutComponent(Sprite_1)
layout:setSize({width = 315.0000, height = 150.0000})
layout:setLeftMargin(-156.1584)
layout:setRightMargin(-158.8416)
layout:setTopMargin(-84.4019)
layout:setBottomMargin(-65.5981)
...
localFrame:setX(1.3401)
localFrame:setY(9.4022)
...
localFrame:setTween(true)
localFrame:setTweenType(0)
localFrame:setX(1.3416)
localFrame:setY(9.4019)
PositionTimeline:addFrame(localFrame)
...
localFrame:setTween(true)
localFrame:setTweenType(0)
localFrame:setScaleX(2.3558)
localFrame:setScaleY(2.3558)
