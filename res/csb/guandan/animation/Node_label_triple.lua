...
local Sprite_1 = cc.Sprite:createWithSpriteFrameName("guandan_label_triple.png")
Sprite_1:setName("Sprite_1")
Sprite_1:setTag(4)
Sprite_1:setCascadeColorEnabled(true)
Sprite_1:setCascadeOpacityEnabled(true)
Sprite_1:setPosition(1.0000, 15.0000)
layout = ccui.LayoutComponent:bindLayoutComponent(Sprite_1)
layout:setSize({width = 216.0000, height = 144.0000})
...
localFrame:setTween(true)
localFrame:setTweenType(0)
localFrame:setScaleX(0.4155)
localFrame:setScaleY(0.4155)
