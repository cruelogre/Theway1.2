...
local Sprite_1 = cc.Sprite:createWithSpriteFrameName("guandan_label_threetwo.png")
Sprite_1:setName("Sprite_1")
Sprite_1:setTag(7)
Sprite_1:setCascadeColorEnabled(true)
Sprite_1:setCascadeOpacityEnabled(true)
Sprite_1:setPosition(0.9997, 8.0000)
layout = ccui.LayoutComponent:bindLayoutComponent(Sprite_1)
layout:setSize({width = 324.0000, height = 156.0000})
layout:setLeftMargin(-161.0003)
layout:setRightMargin(-162.9997)
...
localFrame:setTween(true)
localFrame:setTweenType(0)
localFrame:setScaleX(0.3699)
localFrame:setScaleY(0.3699)
