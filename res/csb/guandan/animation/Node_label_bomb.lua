...
local Sprite_1 = cc.Sprite:createWithSpriteFrameName("guandan_label_bomb.png")
Sprite_1:setName("Sprite_1")
Sprite_1:setTag(16)
Sprite_1:setCascadeColorEnabled(true)
Sprite_1:setCascadeOpacityEnabled(true)
Sprite_1:setPosition(-1.0007, 14.7748)
Sprite_1:setScaleX(3.6593)
Sprite_1:setScaleY(3.6593)
Sprite_1:setOpacity(0)
layout = ccui.LayoutComponent:bindLayoutComponent(Sprite_1)
layout:setSize({width = 300.0000, height = 204.0000})
layout:setLeftMargin(-151.0007)
layout:setRightMargin(-148.9993)
layout:setTopMargin(-116.7748)
layout:setBottomMargin(-87.2252)
...
localFrame:setX(-1.0007)
localFrame:setY(14.7748)
...
localFrame:setTween(true)
localFrame:setTweenType(0)
localFrame:setX(-0.9988)
localFrame:setY(14.7745)
PositionTimeline:addFrame(localFrame)
...
localFrame:setTween(true)
localFrame:setTweenType(0)
localFrame:setScaleX(3.6593)
localFrame:setScaleY(3.6593)
